...
<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="./images/favicon.jpg"> <%-- Biểu tượng (favicon) cho trang web --%>
    ...
    <body>
        <%@include file="header.jsp" %> <%-- Nhúng file header.jsp vào trang này (chứa thanh menu, logo, v.v.) --%>
        <main class="main">
            <div class="container">
                <div class="center-box">
                    <div class="custom-box">
                        ...
                        <form class="register-form" action="Register?action=register" method="POST">
                            ...
                            <%-- Xử lý lựa chọn loại tài khoản (Tìm kiếm hoặc Chính chủ) --%>
                            <%
