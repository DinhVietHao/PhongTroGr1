...
@MultipartConfig(maxFileSize = 16177215) // Giới hạn 16MB
public class UploadImageServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (filePart != null) {
            inputStream = filePart.getInputStream(); // Đọc file thành InputStream
        }
        ...
        if (isUploaded) {
            response.getWriter().println("Success image.");
        } else {
